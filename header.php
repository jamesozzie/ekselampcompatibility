<?php
/**
 * Header template part for Eksell.
 *
 * @package eksell
 */
...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<header id="site-header"<?php echo $header_class_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			...
			<div class="header-inner section-inner">
				...
				<div class="header-titles">
					...
					if ( is_front_page() && is_home() && ! is_paged() ) :
						?>
						<h1 class="<?php echo esc_attr( $site_title_class ); ?>">
							<?php echo $home_link_contents; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</h1>
					<?php else : ?>
					...
					<?php if ( $logo && $show_header_text && ( $site_title || $site_description ) ) : ?>
						...
						<div class="header-logo-text">
							...
							if ( $site_title ) :
								...
								<div class="site-title" aria-hidden="true">
									<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
										<?php echo $site_title; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
									</a>
								</div>
								<?php
							endif;
							...
							if ( $site_description ) :
								?>
								<div class="site-description color-secondary">
