<?php
/**
 * Modal Search template part for Eksell.
 *
 * @package eksell
 */
...
<div class="search-modal cover-modal" [class]="'search-modal cover-modal' + ( ampsearch ? ' show-modal active' : '' )"  data-modal-target-string=".search-modal" aria-expanded="false">
	...
	<div class="search-modal-inner modal-inner bg-body-background">
		...
		<div class="section-inner">
			...
			<a href="#" class="toggle search-untoggle fill-cc-primary" on="tap:AMP.setState({ampsearch: !ampsearch})" data-toggle-target=".search-modal" data-toggle-screen-lock="true" data-toggle-body-class="showing-search-modal" data-set-focus="#site-header .search-toggle">
